...
const RequestsTable = () => {
  ...
  const mockRequests = [{
    ...
    type: 'Repair',
    reason: 'Hydraulic system not working',
    urgency: 'medium',
    status: 'approved',
    requested_at: '2024-01-14T09:15:00Z',
    user: {
      name: 'Jane Smith',
    ...
    id: 3,
    user_id: 5,
    asset_name: 'Desktop Monitor 4K',
    type: 'New Asset',
    reason: 'Current monitor resolution too low',
    urgency: 'low',
    status: 'fulfilled',
    requested_at: '2024-01-13T14:20:00Z',
    user: {
      name: 'Mike Johnson',
    ...
    type: 'Repair',
    reason: 'Paper jam issue recurring',
    urgency: 'medium',
    status: 'rejected',
    requested_at: '2024-01-12T11:45:00Z',
    user: {
      name: 'Sarah Wilson',
  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      filtered = filtered.filter(req => req.asset_name.toLowerCase().includes(searchTerm.toLowerCase()) || req.user?.name.toLowerCase().includes(searchTerm.toLowerCase()) || req.reason.toLowerCase().includes(searchTerm.toLowerCase()));
    }
    if (statusFilter !== 'all') {
  ...
  const getUrgencyBadge = urgency => {
    ...
    return /*#__PURE__*/React.createElement(Badge, {
      className: urgencyConfig[urgency]
    }, urgency === 'high' && /*#__PURE__*/React.createElement(AlertTriangle, {
